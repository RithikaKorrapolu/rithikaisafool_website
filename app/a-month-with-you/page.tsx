...
export default function AMonthWithYou() {
    ...
    <>
      <main className="min-h-screen pb-16" style={{ backgroundColor: '#F2F2F2', paddingTop: 'calc(var(--header-h, 160px) + 20px)' }}>
        <div className="container mx-auto px-6">
          ...
          {/* Two Column Layout */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-0 lg:mt-8">
            {/* Image - Left */}
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-black text-2xl lg:text-4xl font-[family-name:var(--font-inter)] tracking-tight mt-2">
                Follow along <a href="https://www.instagram.com/rithikaisafool" target="_blank" rel="noopener noreferrer" className="font-bold text-blue-500 hover:text-[#F8330D] transition-colors">here</a>.
              </p>
            </div>
          </div>
            ...
            <div className="border-2 border-white rounded-xl p-10 md:p-12 bg-white shadow-lg">
              ...
              <div className="pb-2">
                <p className="text-base lg:text-lg text-black font-[family-name:var(--font-inter)] tracking-tight mt-4 text-left">
                  &ldquo;Most interviews happen in a single one- or two-hour sitting with many of the questions decided ahead of time. I liked the idea that an interview can happen slowly, over the course of a month to catch the guest at different times and emotions to better capture who they are. I also liked the idea that <span className="font-bold">an interview can be more democratic and any invested person can vote</span> on what they want to know next about this person. The goal is for this to feel like almost a <span className="font-bold">communal experience where we&apos;re all participating and getting to know someone <span className="italic">together</span>.</span>&rdquo;
                </p>
