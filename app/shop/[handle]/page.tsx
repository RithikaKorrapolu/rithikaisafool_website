              ...
              {product.title?.toLowerCase().includes('stranger') ? (
                ...
                <div>
                  ...
                  <p className="text-sm text-black font-[family-name:var(--font-inter)] mb-4">
                    Every month, <strong>we pick a theme</strong> and pass it to different people, asking them to <strong>curate art around it</strong>. They send back all kinds of beautiful things - paintings, songs, excerpts from movies, text messages from their mom, whatever they think fits.
                  </p>
                  <p className="text-sm text-black font-[family-name:var(--font-inter)] mb-4">
      ...
      {sizeChartOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-2xl p-8 max-w-4xl mx-4 shadow-2xl relative"
          ...
          >
            ...
            <h2 className="text-xl font-bold text-black font-[family-name:var(--font-inter)] mb-6">
              Size Chart
            </h2>

            <p className="text-base font-semibold text-black font-[family-name:var(--font-inter)] mb-4">
              US Regular
            </p>

            <div className="overflow-x-auto">
              <table className="w-full text-sm text-black font-[family-name:var(--font-inter)]">
                <thead>
