              ...
              {product.title?.toLowerCase().includes('stranger') ? (
                ...
                <div>
                  ...
                  <p className="text-sm text-black font-[family-name:var(--font-inter)] mb-4">
                    Every month, <strong>we pick a theme</strong> and pass it to different people, asking them to <strong>curate art around it</strong>. They send back all kinds of things - paintings, songs, excerpts from movies, text messages from their mom, whatever they think fits.
                  </p>
                  <p className="text-sm text-black font-[family-name:var(--font-inter)] mb-4">
