          ...
          <h1 className="text-white font-[family-name:var(--font-serif)]" style={{
            ...
            {'DO YOU FEEL IT '.split('').map((char, index) => (
              <span
                ...
                style={{
                  display: 'inline-block',
                  transform: mounted ? `translateY(${(Math.sin(index * 0.5) * 8).toFixed(2)}px)` : 'translateY(0)',
            ...
            <span className="whitespace-nowrap">
              {'TOO?'.split('').map((char, index) => (
                <span
                  ...
                  style={{
                    display: 'inline-block',
                    transform: mounted ? `translateY(${(Math.sin((index + 15) * 0.5) * 8).toFixed(2)}px)` : 'translateY(0)',
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col gap-4">
                <div className="flex flex-col md:flex-row gap-2">
                  <input
                    ...
                    className="w-full md:w-1/2 px-3 py-2.5 md:px-4 md:py-3 border border-gray-300 rounded-full text-base md:text-lg text-black focus:outline-none focus:border-[#561DF1]"
                ...
                <div className="flex items-center w-full px-3 py-2.5 md:px-4 md:py-3 border border-gray-300 rounded-full focus-within:border-[#561DF1]" style={{ background: '#f9fafb' }}>
