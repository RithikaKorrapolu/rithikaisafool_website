      ...
      <div className="container mx-auto px-6 max-w-7xl mb-2 md:mb-6">
        <div className="w-full py-4 text-center" style={{ backgroundColor: '#561DF1' }}>
          <h1 className="text-white font-[family-name:var(--font-serif)]" style={{
            ...
            {'DO YOU FEEL IT TOO?'.split('').map((char, index) => (
              <span
                key={index}
                style={{
                  display: 'inline-block',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12">
          ...
          <div className="flex flex-col">
            ...
            <div className="mb-6 flex items-center gap-4">
              <h3 className="text-black font-semibold" style={{ fontFamily: 'Anek Bangla, sans-serif', fontSize: '1.44rem', lineHeight: '1.8' }}>
                FOLLOW US AROUND
              </h3>
          ...
          <div>
            ...
            <div className="border-4 border-dashed px-8 pt-3 pb-4 mb-8" style={{ borderColor: '#561DF1' }}>
              <h2 className="text-center font-bold mb-1 text-black" style={{ fontSize: '1.625rem', fontFamily: 'Anek Bangla, sans-serif', letterSpacing: '-0.05em' }}>
                * A PENNY FOR YOUR THOUGHTS? *
              </h2>

              <p className="text-center mb-6 text-black" style={{ fontSize: '1.3rem', fontFamily: 'Anek Bangla, sans-serif' }}>
              ...
              {/* Penny Image and Calendar/Button Side by Side */}
    ...
    <footer>
      <div className="px-6 py-6 md:py-8" style={{ backgroundColor: '#000000', letterSpacing: '-0.08em' }}>
        ...
        <div className="flex flex-col items-center gap-4 md:hidden">
          {/* Social icons on top for mobile - 2x2 grid */}
          ...
          {/* Copyright */}
          <p className="text-white text-sm font-normal font-[family-name:var(--font-inter)]">
