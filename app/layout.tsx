...
export default function RootLayout({
  ...
  const isStandalonePage = pathname?.startsWith('/stwl') || pathname?.startsWith('/shop/let-me-show-you-sample') || pathname?.startsWith('/let-me-show-you') || pathname === '/theRIAFMuseumOfArt';
