    ...
    <>
      <main className="min-h-screen pb-16" style={{ backgroundColor: '#F2F2F2', paddingTop: 'calc(var(--header-h, 160px) + 20px)' }}>
        <div className="container mx-auto px-6">
          ...
          {/* Video Animation with Button Overlay */}
          <Link
            href="/theRIAFMuseumOfArt"
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none" style={{ paddingBottom: '15%' }}>
                <motion.div
                  ...
                  animate={{
                    ...
                    backgroundColor: isHovered ? 'rgba(0, 0, 0, 0)' : 'rgba(0, 0, 0, 0.5)',
                  }}
                  transition={{
                    duration: 0.8,
                    ease: [0.32, 0.72, 0, 1],
                  ...
                  style={{
                    ...
                    WebkitBackdropFilter: isHovered ? 'none' : 'blur(8px)',
            ...
            <div className="border-2 border-white rounded-xl p-10 md:p-12 bg-white shadow-lg">
              ...
              <div className="pb-2">
                ...
                <p className="text-base lg:text-lg text-black font-[family-name:var(--font-inter)] tracking-tight mt-6 text-left">
                  If I was rich rich and had a museum, it would probably look a lot like this one. All of these pieces moved me in some way. I hope they move you too. The collection grows as I grow.
                </p>
                <p className="text-base lg:text-lg text-black font-[family-name:var(--font-inter)] tracking-tight mt-6 text-left">
                  I think most people connect with art through emotion first. At least I do. So, I wanted to be able to browse by how the art makes me feel, not by title or year. In general, I&apos;m pretty excited about coming up with new ways for people to interact and understand art. If you&apos;ve got any ideas, hit me up!
                </p>
                <p className="text-base lg:text-lg text-black font-[family-name:var(--font-inter)] tracking-tight text-right mt-6">
                  — Rithika
                </p>
                <p className="text-base lg:text-lg text-black font-[family-name:var(--font-inter)] tracking-tight text-right mt-2 italic">
                  P.S. If you liked this, you might want to try <a href="/shop/let-me-show-you" className="underline hover:text-[#F8330D] transition-colors">this</a>
                </p>
              </div>
            </div>
          </motion.div>
