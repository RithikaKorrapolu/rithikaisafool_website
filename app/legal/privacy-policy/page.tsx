export default function PrivacyPolicyPage() {
  return (
    <main className="min-h-screen pt-[160px] pb-12 px-8 font-[family-name:var(--font-inter)] bg-white text-black print:pt-8">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-2">Privacy Policy</h1>
        <p className="text-sm text-gray-600 mb-8">Last updated: April 25, 2026</p>
        ...
        <h2 className="text-xl font-bold mb-3">Personal Information We Collect or Process</h2>
        ...
        <h2 className="text-xl font-bold mb-3">Personal Information Sources</h2>
        <p className="text-base mb-4">We may collect personal information from the following sources:</p>
        <ul className="list-disc ml-8 mb-6 text-base space-y-2">
        ...
        <h2 className="text-xl font-bold mb-3">How We Use Your Personal Information</h2>
        <p className="text-base mb-4">Depending on how you interact with us or which of the Services you use, we may use personal information for the following purposes:</p>
        <ul className="list-disc ml-8 mb-6 text-base space-y-2">
        ...
        <h2 className="text-xl font-bold mb-3">How We Disclose Personal Information</h2>
        <p className="text-base mb-4">In certain circumstances, we may disclose your personal information to third parties for legitimate purposes subject to this Privacy Policy. Such circumstances may include:</p>
        <ul className="list-disc ml-8 mb-6 text-base space-y-2">
        ...
        <h2 className="text-xl font-bold mb-3">Children's Data</h2>
        <p className="text-base mb-6">
        ...
        <h2 className="text-xl font-bold mb-3">Security and Retention of Your Information</h2>
        <p className="text-base mb-6">
        ...
        <p className="text-base mb-4">Depending on where you live, you may have some or all of the rights listed below in relation to your personal information. However, these rights are not absolute, may apply only in certain circumstances and, in certain cases, we may decline your request as permitted by law.</p>
        <ul className="list-disc ml-8 mb-6 text-base space-y-2">
        ...
        <p className="text-base mb-6">
          You may exercise any of these rights where indicated on the Services or by contacting us using the contact details provided below. To learn more about how Shopify uses your personal information and any rights you may have, including rights related to data processed by Shopify, you can visit https://privacy.shopify.com/en. We will not discriminate against you for exercising any of these rights. We may need to verify your identity before we can process your requests, as permitted or required under applicable law. In accordance with applicable laws, you may designate an authorized agent to make requests on your behalf to exercise your rights. Before accepting such a request from an agent, we will require that the agent provide proof you have authorized them to act on your behalf, and we may need you to verify your identity directly with us. We will respond to your request in a timely manner as required under applicable law.
        </p>
        ...
        <p className="text-base mb-8">
          Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please email us at support@rithikaisafool.com or contact us at 10 Eisenhower Drive, Robbinsville Township, NJ, 08691, US.
        </p>
      </div>
    </main>
  );
