...
export const POSTERS = [
  ...
  { id: 12, label: "Quirks", link: "/quirks", shop: false, clientWork: false },
  { id: 11, label: "A Month With You", link: "/a-month-with-you", shop: false, clientWork: false },
  ...
  { id: 13, label: "The RIAF Museum of Art", link: "/theRIAFMuseumOfArt", shop: false, clientWork: false },
