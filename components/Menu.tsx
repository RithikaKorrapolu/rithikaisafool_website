      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-0 top-0 h-full w-[400px] bg-[#F2F2F2] z-[60] p-8 overflow-y-auto font-[family-name:var(--font-inter)]"
            style={{ letterSpacing: '-0.08em' }}
          >
            {/* Close Button */}
            <button
              onClick={onClose}
              className="absolute top-8 right-8 text-2xl font-bold text-black hover:text-[#F8330D] transition-colors"
            >
              X
            </button>

            {/* Header */}
            <h2 className="text-3xl font-bold mb-4 border-b-4 border-black inline-block pb-2 text-black">
              Take a look!
            </h2>
